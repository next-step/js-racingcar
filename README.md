...
- [x] 자동차 이름은 쉼표(,)를 기준으로 구분하며 이름은 5자 이하만 가능하다.
  - [x] 쉼표를 기준으로 5글자가 넘어가는 이름이 있으면 경고창을 띄운다.
  - [x] 최소한 하나의 자동차도 없으면 경고창을 띄운다.
  - [x] 제대로 입력됐다면 시도 횟수를 입력받는 입력창과 버튼을 보여준다.
- [x] 사용자는 몇 번의 이동을 할 것인지를 입력할 수 있어야 한다.
  - [x] 시도 횟수가 1보다 작으면 경고창을 띄운다.
  - [x] 시도 횟수를 입력하지 않았으면 경고창을 띄운다.
- [x] 주어진 횟수 동안 n대의 자동차는 전진 또는 멈출 수 있다.
  - [x] 전진을 했다면 해당 자동차에 전진 표시를 추가한다.
