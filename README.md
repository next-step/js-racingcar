...
<p align="middle">
  <a href="https://glassyi.github.io/js-racingcar/">🖥️ 데모 링크</a>
</p>
...
- [v] 전진하는 조건은 0에서 9 사이에서 random 값을 구한 후 random 값이 4 이상일 경우 전진하고, 3 이하의 값이면 멈춘다.
- [v] 자동차 경주 게임을 완료한 후 누가 우승했는지를 알려준다. 우승자는 한 명 이상일 수 있다.
- [v] 우승자가 여러명일 경우 `,`를 이용하여 구분한다.
