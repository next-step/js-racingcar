...
import { ROUND_INPUT_ERROR_MESSAGES } from "../../src/js/utils/errorMessage";
import { CAR_CONTAINER, ROUND_INPUT } from "../../src/js/utils/selector";
...
describe("input rounds", () => {
  ...
  it("0 입력", () => {
    ...
    cy.checkAlertMessage(ROUND_INPUT_ERROR_MESSAGES.ROUNDS_IN_NOT_POSITIVE_INTEGER);
    cy.checkHandleInvalidRounds();
  });
