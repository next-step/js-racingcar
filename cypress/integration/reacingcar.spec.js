...
describe('자동차 경주 게임', () => {
  ...
  it('자동차 이름을 입력하는 입력창과 확인 버튼이 존재한다.', () => {
    ...
    cy.get(SELECTORS.CAR_NAME_SUBMIT).should('be.visible');
  });
  ...
  it('자동차 이름으로 빈값을 입력하면 경고창이 출력된다.', () => {
    ...
    cy.get(SELECTORS.CAR_NAME_SUBMIT)
      .click()
      .then(() => {
  ...
  it('자동차 이름을 입력하면 자동차 이름 입력창과 버튼이 비활성화 된다.', () => {
    cy.get(SELECTORS.CAR_NAME_INPUT).type('EAST,WEST,SOUTH,NORTH');
    cy.get(SELECTORS.CAR_NAME_SUBMIT).click();
    cy.get(SELECTORS.CAR_NAME_INPUT).should('be.disabled');
    cy.get(SELECTORS.CAR_NAME_SUBMIT).should('be.disabled');
  });
  ...
  it('자동차 이름을 입력하면 시도 횟수 입력창과 버튼이 노출된다.', () => {
    ...
    cy.get(SELECTORS.RACE_LAP_SUBMIT).should('be.visible');
  });
  ...
  it('시도할 횟수를 빈값으로 입력하면 경고창이 출력된다.', () => {
    ...
    cy.get(SELECTORS.RACE_LAP_SUBMIT)
      .click()
      .then(() => {
  ...
  it('시도할 횟수를 입력하면 시도 횟수 입력창과 버튼이 비활성화 된다.', () => {
    ...
    cy.get(SELECTORS.RACE_LAP_SUBMIT).click();
    cy.get(SELECTORS.RACE_LAP_INPUT).should('be.disabled');
    cy.get(SELECTORS.RACE_LAP_SUBMIT).should('be.disabled');
  });
});
