...
export default function RacingBeforeStartForm({ $el, props }) {
    const state = {
        carNames: [],
    };
    function onSubmitCarNamesForm(event) {
    ...
    function typeCarNames(carNamesText) {
        if (typeof carNamesText !== 'string') {
            return;
        }
    ...
    function onSubmitNumberOfTryForm(event) {
        event.preventDefault();
        const formData = new FormData(event.target);
    ...
    function disableFieldset({ fieldName }) {
...
//# sourceMappingURL=RacingBeforeStartForm.js.map