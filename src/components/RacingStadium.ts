import {ComponentParam, PROGRESS} from "../types/common.js";
...
export default function RacingStadium({$el, props}: ComponentParam<Props>) {
    ...
    function playRound(carNames) {
        ...
        carNames.forEach(carName => {
            const progress: PROGRESS = RacingService.getForwardOrStop();
