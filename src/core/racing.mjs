import {BOOSTER_GAGE, MSG_ERROR_INVALID_NUMBER, MSG_ERROR_NO_NAMES} from "./constants.mjs";
...
export const getCommand = (number) => (number >= BOOSTER_GAGE ? COMMAND_GO : COMMAND_STOP);
